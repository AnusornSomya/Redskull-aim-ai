...
namespace Redskull.Class
{
    ...
    {
        public const string LockedDetectionAreaType = "Closest to Mouse";
        public const string LockedAimingBoundariesAlignment = "Center";
        ...
        public static Dictionary<string, dynamic> dropdownState = new()
        {
            ...
            { "Detection Area Type", LockedDetectionAreaType },
            { "Aiming Boundaries Alignment", LockedAimingBoundariesAlignment },
        ...
        public static void EnforceLockedSelections()
        {
            dropdownState["Detection Area Type"] = LockedDetectionAreaType;
            dropdownState["Aiming Boundaries Alignment"] = LockedAimingBoundariesAlignment;
        }
