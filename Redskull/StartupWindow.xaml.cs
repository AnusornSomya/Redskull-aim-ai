    ...
    public partial class StartupWindow : Window
    {
        ...
        private async void Window_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                await Dispatcher.InvokeAsync(() => LoadingText.Text = "กำลังเปิดหน้าจอหลัก...");
        ...
        private void UpdateParticleColors(Color baseColor)
        {
            ...
            if (FindName("RedskullLogo") is FrameworkElement logo && logo.Effect is DropShadowEffect shadowEffect)
